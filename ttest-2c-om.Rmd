...
if (et) {s2f1<- s1^2; s2f2 <- s2^2} else {s2f1<- s2p; s2f2 <- s2p}
```
...
<!-- $$ -->
<!--   S^2_\text{`r a`}=\frac{n_\text{`r a`}}{n_\text{`r a`}-1}\hat\sigma_\text{`r a`}=\frac{`r n1`}{`r n1`-1}`r s1h^2`=`r s1^2` \qquad` -->
<!--   S^2_\text{`r b`}=\frac{n_\text{`r b`}}{n_\text{`r b`}-1}\hat\sigma_\text{`r b`}=\frac{`r n2`}{`r n2`-1}`r s2h^2`=`r s2^2` -->
<!-- $$ -->
...
\begin{eqnarray*}
 ...
 {\sqrt{\frac {S^2_p}{n_\text{`r a`}}+\frac {S^2_p}{n_\text{`r b`}}}}&\sim&t_{n_\text{`r a`}+n_\text{`r b`}-2}\\
    t_{\text{obs}}
